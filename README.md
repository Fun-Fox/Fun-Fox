## Hi 我是 Fun-Fox，专注于 AI+自动化、数据分析 的开发。
...
| [SmartDigger](https://github.com/Fun-Fox/SmartDigger) | 基于视觉大模型的"自动化任务"异常诊断中心，用于检测与修复自动化流程中的问题。 |

### 🎵 音频与音乐处理工具

| 项目名称 | 用途说明 |
|---------|----------|
| [SunoSongDo](https://github.com/Fun-Fox/SunoSongDo) | 从 Suno 平台自动采集 AI 生成的歌曲，构建个性化音乐库，支持批量下载与分类管理。 |
| [MutilsSingSong](https://github.com/Fun-Fox/MutilsSingSong) | 四宫格互动视频生成工具，使用 Whisper 对翻唱内容进行语音识别，实现多歌手自动歌词对齐。 |

### 📹 视频创作工具

| 项目名称 | 用途说明 |
|---------|----------|
| [VideoCube](https://github.com/Fun-Fox/VideoCube) | 视频创作魔方，提供一站式视频生成解决方案，支持多模态内容融合与创意输出。 |
